...
import 'package:frontend/core/widgets/pulse_clock.dart'; // [ADD]
import 'package:frontend/core/services/api_service.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:frontend/core/providers/branding_provider.dart';
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(color: PulseColors.primary.withOpacity(0.1), shape: BoxShape.circle),
        ...
        children: [
          RichText(
            text: TextSpan(children: [
              ...
              if (unit.isNotEmpty) TextSpan(text: ' $unit', style: PulseTextStyles.captionBold.copyWith(fontSize: 8, color: color.withOpacity(0.6))),
            ]),
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: PulseColors.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
