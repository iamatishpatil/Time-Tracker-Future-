...
import 'package:frontend/core/widgets/pulse_app_bar.dart';
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Container(width: 120, height: 6, decoration: BoxDecoration(color: PulseColors.textSecondary.withOpacity(0.5), borderRadius: BorderRadius.circular(4))),
                                ])),
                              ],
                            ),
                          ),
