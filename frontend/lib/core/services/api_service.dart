...
class ApiService {
  // Dynamic base URL resolution for Android Emulators (10.0.2.2), iOS/Desktop (127.0.0.1/localhost) & LAN IP
  ...
  static Future<Map<String, dynamic>> login(String mobileNumber, String password, {String? biometricToken}) async {
    try {
      final body = <String, String>{'mobileNumber': mobileNumber, 'password': password};
      if (biometricToken != null) {
        body['biometricToken'] = biometricToken;
      }
      if (FirebaseService.fcmToken != null) {
        body['fcmToken'] = FirebaseService.fcmToken!;
      }
